...
- [ ] `Runner._normalize_targets` always rescales weights to sum to 1 (its docstring says "at most 1"); `run_paper.py` doesn't normalize at all, so backtest and paper size positions differently
